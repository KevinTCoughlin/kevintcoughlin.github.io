...
const u = new Set(),
  ...
  p = () => {
    if (l < 0) {
      const e = o(),
        n = document.prerendering
          ? void 0
          : globalThis.performance
              .getEntriesByType('visibility-state')
              .find((t) => 'hidden' === t.name && t.startTime >= e)?.startTime;
      ((l = n ?? m()),
        ...
        for (const t of e)
          'first-contentful-paint' === t.name &&
            ...
            t.startTime < c.firstHiddenTime &&
              ((d.value = Math.max(t.startTime - o(), 0)), d.entries.push(t), a(!0)));
      });
      f &&
        ((a = n(e, d, y, s.reportAllChanges)),
        t((t) => {
          ((d = r('FCP')),
            (a = n(e, d, y, s.reportAllChanges)),
            i(() => {
      ...
      if (
        (n
          ? e.duration > n.L
            ...
            : e.duration === n.L && e.startTime === n.entries[0].startTime && n.entries.push(e)
...
const A = (e) => {
    ...
    if ('hidden' === document.visibilityState) e();
      ...
      (addEventListener('visibilitychange', o, { once: !0, capture: !0 }),
        (s = t(() => {
...
const N = [2500, 4e3],
      ...
      const u = a(s, q),
        m = (e) => {
          ...
          for (const t of e)
            (u.h(t),
              t.startTime < c.firstHiddenTime &&
                ((l.value = Math.max(t.startTime - o(), 0)), (l.entries = [t]), d()));
        },
  ...
  $ = (e, i = {}) => {
    ...
    O(() => {
      const d = s();
      d &&
        ((c.value = Math.max(d.responseStart - o(), 0)),
        (c.entries = [d]),
        a(!0),
        t(() => {
